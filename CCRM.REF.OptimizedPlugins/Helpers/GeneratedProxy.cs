...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName = "ICmmsServiceRequestManagerAAD")]
public interface ICmmsServiceRequestManagerAAD
{

    [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICmmsServiceRequestManagerAAD/UpdateServiceRequestDetails", ReplyAction = "http://tempuri.org/ICmmsServiceRequestManagerAAD/UpdateServiceRequestDetailsRespo" +
        "nse")]
    bool UpdateServiceRequestDetails(Cmms.ServiceManagement.Services.ServiceRequest servicerequest);

    [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICmmsServiceRequestManagerAAD/UpdateServiceRequestDetails", ReplyAction = "http://tempuri.org/ICmmsServiceRequestManagerAAD/UpdateServiceRequestDetailsRespo" +
        "nse")]
    System.Threading.Tasks.Task<bool> UpdateServiceRequestDetailsAsync(Cmms.ServiceManagement.Services.ServiceRequest servicerequest);

    [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICmmsServiceRequestManagerAAD/GenerateToken", ReplyAction = "http://tempuri.org/ICmmsServiceRequestManagerAAD/GenerateTokenResponse")]
    string GenerateToken(string iD, string key);

    [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICmmsServiceRequestManagerAAD/GenerateToken", ReplyAction = "http://tempuri.org/ICmmsServiceRequestManagerAAD/GenerateTokenResponse")]
    System.Threading.Tasks.Task<string> GenerateTokenAsync(string iD, string key);

}

[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface ICmmsServiceRequestManagerAADChannel : ICmmsServiceRequestManagerAAD, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class CmmsServiceRequestManagerAADClient : System.ServiceModel.ClientBase<ICmmsServiceRequestManagerAAD>, ICmmsServiceRequestManagerAAD
{

    public CmmsServiceRequestManagerAADClient()
    {
    }

    public CmmsServiceRequestManagerAADClient(string endpointConfigurationName) :
            base(endpointConfigurationName)
    {
    }

    public CmmsServiceRequestManagerAADClient(string endpointConfigurationName, string remoteAddress) :
            base(endpointConfigurationName, remoteAddress)
    {
    }

    public CmmsServiceRequestManagerAADClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) :
            base(endpointConfigurationName, remoteAddress)
    {
    }

    public CmmsServiceRequestManagerAADClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) :
            base(binding, remoteAddress)
    {
    }

    public bool UpdateServiceRequestDetails(Cmms.ServiceManagement.Services.ServiceRequest servicerequest)
    {
        return base.Channel.UpdateServiceRequestDetails(servicerequest);
    }

    public System.Threading.Tasks.Task<bool> UpdateServiceRequestDetailsAsync(Cmms.ServiceManagement.Services.ServiceRequest servicerequest)
    {
        return base.Channel.UpdateServiceRequestDetailsAsync(servicerequest);
    }

    public string GenerateToken(string iD, string key)
    {
        return base.Channel.GenerateToken(iD, key);
    }

    public System.Threading.Tasks.Task<string> GenerateTokenAsync(string iD, string key)
    {
        return base.Channel.GenerateTokenAsync(iD, key);
    }
